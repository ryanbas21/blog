...
test('Submit Post :: should return action object with POST', (t) => {
	let expected = {
			type: 'SUBMIT_POST',
			payload: 'file.txt'
		},
...
test('Get Posts Success :: Action should return object with payload', (t) => {
	let expected = {
...
test('PostsReducer :: GET_POSTS_SUCCESS', (t) => {
	let payload = [
		{
			url: 'example post',
